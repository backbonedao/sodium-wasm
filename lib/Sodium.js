...
function readAsmConstArgs(sigPtr, buf) {
    ...
    while(ch = HEAPU8[sigPtr++]){
        ...
        readAsmConstArgsArray.push(// @ts-ignore
...
let crypto_generichash_STATEBYTES;
let crypto_hash_sha256_STATEBYTES;
let crypto_hash_sha512_STATEBYTES;
let crypto_onetimeauth_STATEBYTES;
let crypto_pwhash_ALG_ARGON2I13;
let crypto_pwhash_ALG_ARGON2ID13;
let crypto_secretstream_xchacha20poly1305_TAG_MESSAGE;
let crypto_secretstream_xchacha20poly1305_TAG_PUSH;
let crypto_secretstream_xchacha20poly1305_TAG_REKEY;
let crypto_secretstream_xchacha20poly1305_TAG_FINAL;
let crypto_secretstream_xchacha20poly1305_STATEBYTES;
let crypto_sign_STATEBYTES;
async function init() {
    // const mod = new WebAssembly.Module(Buffer.from(WASM, "base64"));
    const mod = await WebAssembly.compile(_buffer.Buffer.from(_wasm.WASM, "base64"));
    ...
    crypto_secretstream_xchacha20poly1305_TAG_MESSAGE = _buffer.Buffer.from([
        Sodium.crypto_secretstream_xchacha20poly1305_tag_message(), 
    ]);
    crypto_secretstream_xchacha20poly1305_TAG_PUSH = _buffer.Buffer.from([
        Sodium.crypto_secretstream_xchacha20poly1305_tag_push(), 
    ]);
    crypto_secretstream_xchacha20poly1305_TAG_REKEY = _buffer.Buffer.from([
        Sodium.crypto_secretstream_xchacha20poly1305_tag_rekey(), 
    ]);
    crypto_secretstream_xchacha20poly1305_TAG_FINAL = _buffer.Buffer.from([
